...
{
  /// <summary>
  /// An NHibernate <c>IUserType</c> for storing a GUID as a series of binary bytes.
  /// </summary>
  public class BinaryGuidType : IUserType
  {
    ...
    public object NullSafeGet (IDataReader rs, string[] names, object owner)
    {
      ...
      if(bytes == null || bytes.Length != BYTE_COUNT)
      {
        return null;
      }

      return bytes.FromRFC4122ByteArray();
    }
    ...
    public void NullSafeSet (IDbCommand cmd, object value, int index)
    {
      if(value != null)
      {
        var bytes = ((Guid) value).ToRFC4122ByteArray();
