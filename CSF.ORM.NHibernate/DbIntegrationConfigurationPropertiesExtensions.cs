...
namespace CSF.ORM.NHibernate
{
  ...
  public static class DbIntegrationConfigurationPropertiesExtensions
  {
    ...
    /// driver.  This method will use <see cref="MonoRuntimeDetector"/> and, if we are on Mono,
                                            ...
                                            bool? forceMono)
    {
      ...
      var mono = forceMono.HasValue? forceMono.Value : monoDetector.IsExecutingWithMono();
    ...
    /// <summary>
    /// Initializes the <see cref="DbIntegrationConfigurationPropertiesExtensions"/> class.
    /// </summary>
