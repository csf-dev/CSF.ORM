...
namespace CSF.ORM.NHibernate
{
  ...
  public class MonoNHibernateSqlLiteDriver : ReflectionBasedDriver
  {
    ...
    /// <summary>
    /// Gets a value indicating whether this <see cref="CSF.ORM.NHibernate.MonoNHibernateSqlLiteDriver"/> uses named
    ...
    /// <summary>
    /// Gets a value indicating whether this <see cref="CSF.ORM.NHibernate.MonoNHibernateSqlLiteDriver"/> supports
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CSF.ORM.NHibernate.MonoNHibernateSqlLiteDriver"/> class.
    /// </summary>
